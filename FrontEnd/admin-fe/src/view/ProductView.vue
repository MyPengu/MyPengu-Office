<template>
    <div>
        ...
        <div class="pagination" v-show="!noData">
            <Pagination ref="pagination" :itemCount="totalItems" :maxDisplayPage="3" :page="page" :perPage="18" @pageChange="pageChange"></Pagination>
        </div>
...
export default {
    ...
    methods:{
        ...
        deleteItem(item){
            this.item = item;
            this.title = `Bạn có thật sự muốn xóa sản phẩm này không.`
